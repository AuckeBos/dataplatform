...
This document describes how I envision the dataplatform. I try to generate the code as much as possible, using [Aider](https://aider.chat/).
...
- Silver. In this layer, we maintain SCD2 history. We use sqlaclhemy ORM for this. The bronze-silver entity relationship is one-to-one. There is no flattening or simplifying. The goal of the silver layer is to maintain scd2 history using generic logic.
